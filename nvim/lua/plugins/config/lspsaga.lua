return function()
  local icons = {
    cmp = require("plugins.config.icons").get("cmp", true),
    diagnostics = require("plugins.config.icons").get("diagnostics", true),
    kind = require("plugins.config.icons").get("kind", true),
    type = require("plugins.config.icons").get("type", true),
    ui = require("plugins.config.icons").get("ui", true),
  }
  ...
  require("lspsaga").setup({
    ...
    -- Callhierarchy: https://dev.neovim.pro/lspsaga/callhierarchy/
    callhierarchy = {
      layout = "float",
      keys = {
        edit = "e",
    ...
    -- Code Action: https://dev.neovim.pro/lspsaga/codeaction/
    code_action = {
      num_shortcut = true,
    ...
    hover = {
      ...
      max_height = 0.7,
      open_link = "gl",
      -- open_cmd = "silent !" .. require("base.settings").external_browser,
    },
    ...
    -- Generic UI Options: https://nvimdev.gihtub.io/lspsaga/misc/#generic-ui-options
    ui = {
    ...
    -- Scrolling: https://nvimdev.github.io/lspsaga/misc/#scrolling-keymaps
    scroll_preview = {
      scroll_down = "<C-d>",
      scroll_up = "<C-u>",
    },
