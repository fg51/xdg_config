return function()
  local icons = {
    kind = require("plugins.config.icons").get("kind"),
    type = require("plugins.config.icons").get("type"),
    cmp = require("plugins.config.icons").get("cmp"),
  }
  ...
  require("cmp").setup({
    ...
    sources = {
      { name = "nvim_lsp", max_item_count = 350, keyword_length = 2 },
